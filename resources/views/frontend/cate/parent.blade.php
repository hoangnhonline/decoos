                ...
                <div class="filter-total">
                    ...
                    <div class="filter-attr clearfix">
                        <div class="col-sm-2 block-title">
                            <h2>{{ trans('text.category-short') }}</h2>
                        </div>
        ...
        <div class="container block-filter block-filter-rule">
            ...
            <div class="block-content">
                <ul>
                    ...
                    @endif
                    @if($cid > 0)             
                    <li ><b>{{ trans('text.category-short') }}:</b> <a href="javascript:;" id="filter-category">{{ $lang == 'vi' ? $cateSelected->name_vi : $cateSelected->name_en }}</a></li>
                    @endif
                    @if($mid > 0)
