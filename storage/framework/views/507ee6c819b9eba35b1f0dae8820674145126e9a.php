                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <ul id="introduce-company"  class="introduce-list">
                                ...
                                <li><a href="<?php echo e(route('news-list', 'tuyen-dung')); ?>">Tuyển dụng</a></li>
                        ...
                        <div class="col-sm-4">
                            ...
                            <ul id = "introduce-Account" class="introduce-list">
                                <li><a href="<?php echo e(route('danh-muc-cha', 'huong-dan-mua-hang')); ?>">Hướng dẫn mua hàng</a></li>
                        ...
                        <div class="col-sm-4">
                            ...
                            <ul id = "introduce-support"  class="introduce-list">
                                ...
                                <li><a href="<?php echo e(route('danh-muc-cha', 'chinh-sach-doi-tra')); ?>">Chính sách đổi trả</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
