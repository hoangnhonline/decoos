...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php endif; ?>
      <a href="<?php echo e(route('pages.create')); ?>" class="btn btn-info" style="margin-bottom:5px">Tạo mới</a>
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td style="white-space:nowrap">   
                  ...
                  <a class="btn btn-default btn-sm" href="<?php echo e(route('danh-muc-cha', $item->slug )); ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>               
                  <a href="<?php echo e(route( 'pages.edit', [ 'id' => $item->id ])); ?>" class="btn btn-warning">Chỉnh sửa</a>                 
                  
                  <a onclick="return callDelete('<?php echo e($item->title); ?>','<?php echo e(route( 'pages.destroy', [ 'id' => $item->id ])); ?>');" class="btn btn-danger">Xóa</a>
