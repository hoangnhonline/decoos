                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="home">
                        <div class="form-group col-md-6 none-padding">
                          ...
                          <select class="form-control" name="loai_id" id="loai_id">
                            ...
                            <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $detail->loai_id ? "selected" : ""); ?>><?php echo e($value->name_vi); ?></option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                          ...
                          <select class="form-control" name="cate_id" id="cate_id">
                            ...
                            <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $detail->cate_id ? "selected" : ""); ?>><?php echo e($value->name_vi); ?></option>
                            <?php endforeach; ?>
                          </select>
                        </div>  
                        <div class="form-group" >                  
                          <label>Mã <span class="red-star">*</span></label>
                          <input type="text" class="form-control" name="code" id="code" value="<?php echo e(old('code') ? old('code') : $detail->code); ?>">
                        </div>
                        <div class="form-group" >                  
                        ...
                        <div class="col-md-6 none-padding">
                          <div class="checkbox">
                              <label><input type="checkbox" name="is_hot" value="1" <?php echo e($detail->is_hot == 1 ? "checked" : ""); ?>> Sản phẩm HOT </label>
                          </div>                          
                        </div>
                        <div class="col-md-6 none-padding pleft-5">
                            <div class="checkbox">
                              <label><input type="checkbox" name="is_sale" value="1" <?php echo e($detail->is_sale == 1 ? "checked" : ""); ?>> Sản phẩm SALE </label>
                          </div>
                        </div>
                        <div class="form-group" >                  
                            <label>Giá<span class="red-star">*</span></label>
                            <input type="text" class="form-control" name="price" id="price" value="<?php echo e(old('price') ? old('price') : $detail->price); ?>">
                        </div>
                        <div class="form-group col-md-6 none-padding" >                  
                            <label>Giá sale</label>
                            <input type="text" class="form-control" name="price_sale" id="price_sale" value="<?php echo e(old('price_sale') ? old('price_sale') : $detail->price_sale); ?>">
                        </div>
                        <div class="form-group col-md-6 none-padding pleft-5" >                  
                            <label>Phần trăm sale (%) </label>
                            <input type="text" class="form-control" name="sale_percent" id="sale_percent" value="<?php echo e(old('sale_percent') ? old('sale_percent') : $detail->sale_percent); ?>">
                        </div>
                         <div class="form-group">
                          <label>Chi tiết</label>
                          <textarea class="form-control" rows="10" name="content_vi" id="content_vi"><?php echo e(old('content_vi') ? old('content_vi') : $detail->content_vi); ?></textarea>
                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="homeEn">                        
                        ...
                        <div class="form-group">                  
                         ...
                         <div class="form-group">
                          <label>Detail</label>
                          <textarea class="form-control" rows="10" name="content_en" id="content_en"><?php echo e(old('name_en') ? old('name_en') : $detail->name_en); ?></textarea>
                        </div>
                        <div class="clearfix"></div>
                    </div><!--end thong tin co ban--> 
