...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default" href="<?php echo e(route('pages.index')); ?>" style="margin-bottom:5px">Quay lại</a>
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default" class="btn btn-primary" href="<?php echo e(route('pages.index')); ?>">Hủy</a>
            </div>
