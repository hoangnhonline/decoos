...
<section class="content-header">
  <h1>
    Danh mục con của : <span class="cate-name"><?php echo e($loaiSp->name_vi); ?></span>
  </h1>
  <ol class="breadcrumb">
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php endif; ?>
      <a href="<?php echo e(route('cate.create', [$loai_id])); ?>" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
          ...
          <form class="form-inline" role="form" method="GET" action="<?php echo e(route('cate.index')); ?>" id="formSearch">
            <div class="form-group">
              ...
              <select class="form-control" name="loai_id" id="loai_id">
                ...
                <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $loai_id ? "selected" : ""); ?>><?php echo e($value->name_vi); ?></option>
                <?php endforeach; ?>
              </select>
            </div>            
          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td>                  
                  <a href="<?php echo e(route( 'cate.edit', [ 'id' => $item->id ])); ?>"><?php echo e($item->name_vi); ?></a>                

                  <p><?php echo e($item->description); ?></p>
                </td> 
                <td style="text-align:center"><a class="btn btn-info" href="<?php echo e(route('cate.index', [$item->id])); ?>"><?php echo e($item->sanPham->count()); ?></a></td>                           
                
                <td style="white-space:nowrap; text-align:right">                 
                  <a href="<?php echo e(route( 'cate.edit', [ 'id' => $item->id ])); ?>" class="btn-sm btn btn-warning">Chỉnh sửa</a>                 
                  <?php if($item->sanPham->count() == 0): ?>
