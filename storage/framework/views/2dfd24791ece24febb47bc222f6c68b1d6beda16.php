          ...
          <form class="form-inline" id="searchForm" role="form" method="GET" action="<?php echo e(route('product.index')); ?>">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="loai_id" id="loai_id">
                ...
                <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $arrSearch['loai_id'] ? "selected" : ""); ?>><?php echo e($value->name_vi); ?></option>
                <?php endforeach; ?>
              </select>
            </div>
              <div class="form-group">
              ...
              <select class="form-control" name="cate_id" id="cate_id">
                ...
                <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $arrSearch['cate_id'] ? "selected" : ""); ?>><?php echo e($value->name_vi); ?></option>
                <?php endforeach; ?>
              </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label><input type="checkbox" name="is_hot" value="1" <?php echo e($arrSearch['is_hot'] == 1 ? "checked" : ""); ?>> Hiện trang chủ</label>              
            </div>
            <div class="form-group">
              <label><input type="checkbox" name="is_sale" value="1" <?php echo e($arrSearch['is_sale'] == 1 ? "checked" : ""); ?>> Giảm giá</label>              
            </div>            
          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td>                  
                  <a style="color:#333;font-weight:bold" href="<?php echo e(route( 'product.edit', [ 'id' => $item->id ])); ?>"><?php echo e($item->name_vi); ?> <?php echo e($item->name_vi_extend); ?></a> &nbsp; <?php if( $item->is_hot == 1 ): ?>
                ...
                <td style="white-space:nowrap; text-align:right">
                  <a class="btn btn-default btn-sm" href="<?php echo e(route('chi-tiet', $item->slug )); ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
                  <?php if( in_array($item->cate_id, [31,85])): ?>
                  <?php 
                  if($item->cate_id == 31){
                  ...
                  ?>
                  <a href="<?php echo e(route( 'product.tuong-thich', [ 'id' => $item->id ])); ?>" class="btn btn-info btn-sm"><span class="badge"><?php echo e($countTuongThich); ?></span> SP tương thích</a>                 
                  <?php endif; ?>
                  <a href="<?php echo e(route( 'product.edit', [ 'id' => $item->id ])); ?>" class="btn btn-warning btn-sm">Chỉnh sửa</a>                 

                  <a onclick="return callDelete('<?php echo e($item->name_vi); ?>','<?php echo e(route( 'product.destroy', [ 'id' => $item->id ])); ?>');" class="btn btn-danger btn-sm">Xóa</a>
