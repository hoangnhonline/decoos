                          ...
                          <div class="row row-address-list">
                            <div class="col-lg-6 col-md-6 col-sm-6 item">
                              <div class="panel panel-default address-item is-default">
                                <div class="panel-body">
                                  <?php if($is_vanglai == 0): ?>
                                  <p class="name"><?php echo e($customer->full_name); ?></p>
                                  <p class="address">
                                  ...
                                  <p class="phone">Điện thoại: <?php echo e($customer->phone); ?></p>
                                  <?php else: ?>
                                  <p class="name"><?php echo e($vangLaiArr['full_name']); ?></p>
                                  <p class="address">
                                  ...
                                  <p class="phone">Điện thoại: <?php echo e(isset( $vangLaiArr['phone'] ) ?  $vangLaiArr['phone'] : $customer->phone); ?></p>
                                  <?php endif; ?>
                                  <p class="action">
                                    <button type="button" class="btn btn-default btn-custom1 saving-address is-red" onclick="location.href='<?php echo e(route('shipping-step-3')); ?>'"> Giao đến địa chỉ này </button>
                        ...
                        <form class="form-horizontal bv-form" role="form" id="address-info" novalidate>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-8 input-wrap has-feedback">
                                <input type="text" name="full_name" class="form-control address" id="full_name" value="<?php echo e($is_vanglai == 1 && isset($vangLaiArr['full_name']) ? $vangLaiArr['full_name'] : $customer->full_name); ?>" placeholder="Nhập họ tên" data-bv-field="full_name">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-8 input-wrap has-feedback">
                              <input type="tel" name="telephone" class="form-control address" id="telephone" value="<?php echo e($is_vanglai == 1 && isset($vangLaiArr['phone']) ? $vangLaiArr['phone'] : $customer->phone); ?>" placeholder="Nhập số điện thoại" data-bv-field="telephone">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-8 input-wrap has-feedback">
                              <input type="email" name="email" class="form-control address" id="email_form" value="<?php echo e($is_vanglai == 1 && isset($vangLaiArr['email']) ? $vangLaiArr['email'] : $customer->email); ?>" placeholder="Nhập email" data-bv-field="email">
                            ...
                            <div class="col-lg-8 input-wrap has-feedback">
                              <select name="city_id" class="form-control address" id="city_id" data-bv-field="city_id">
                                ...
                                <?php foreach($listCity as $city): ?>
                                  ...
                                  <?php if(($customer->city_id == $city->id) || ($is_vanglai == 1 && isset($vangLaiArr['city_id']) && $vangLaiArr['city_id'] == $city->id)): ?>
                                  selected
                                  <?php endif; ?>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-8 input-wrap has-feedback">
                              <textarea name="street" class="form-control address" id="street" placeholder="Ví dụ: 52, đường Trần Hưng Đạo" data-bv-field="street" style="height:50px"><?php echo e($is_vanglai == 1 && isset($vangLaiArr['address']) ? $vangLaiArr['address'] : $customer->address); ?></textarea>
                          ...
                          <div class="form-group row form-group-radio group-radio-k-address">
                            ...
                            <div class="col-lg-8 input-wrap has-feedback">
                                <label class="checkbox-inline">
                                  ...
                                  <?php if($customer->address_type == 0 || ($is_vanglai == 1 && isset($vangLaiArr['address_type']) && $vangLaiArr['address_type'] == 0)): ?>
                                  checked
                                  <?php endif; ?>
                                  >
                                   Nhà riêng / Chung cư
                                ...
                                <label class="checkbox-inline">
                                  ...
                                  <?php if($customer->address_type == 1 || ($is_vanglai == 1 && isset($vangLaiArr['address_type']) && $vangLaiArr['address_type'] == 1)): ?>
                                  checked
                                  <?php endif; ?>
                                  >
                                   Cơ quan / Công ty
                          ...
                          <div class="form-group row end">
                            <div class="col-lg-offset-4 col-lg-8">
                              <?php if(!Session::has('new-register')): ?>
                              <button type="button" class="btn btn-default btn-custom2 visible-lg-inline-block js-hide">Hủy bỏ</button>
                              <?php endif; ?>
                              <div id="btn-address" class="btn btn-primary btn-custom3" value="update"><?php echo e($is_vanglai == 1 ? "Tiếp tục" : "Cập nhật"); ?></div>
                            </div>
                          </div>
                        </form>
                      </div>
                  ...
                  <div class="col-lg-4">
                    <div id="panel-cart">
                      <div class="panel panel-default cart">
                        <div class="panel-body">
                          <div class="order"> <span class="title">Đơn Hàng</span> <span class="title">( <?php echo e(array_sum($getlistProduct)); ?> SP )</span> <a href="<?php echo e(route('gio-hang')); ?>" class="btn btn-default btn-custom1">Sửa</a> </div>
                          <div class="product">
                            <?php $total = 0; ?>
                            <?php foreach($arrProductInfo as $product): ?>
                            <div class="item">
                              <p class="title"><strong><?php echo e($getlistProduct[$product->id]); ?> x</strong><a href="" target="_blank"><?php echo e($product->name); ?></a></p>
                              <p class="price"> <span>
                              <?php 
                          ...
                          <p class="total"> Tạm Tính: <span><?php echo e(number_format($total)); ?>&nbsp;₫</span> </p>
                          ...
                          <p class="total2"> Thành tiền: <span><?php echo e(number_format( $total + $totalServiceFee )); ?>&nbsp;₫ </span> </p>
...
<?php $__env->startSection('javascript'); ?>
   <script type="text/javascript">
    $(document).ready(function() {
      ...
      var customer_district_id = '<?php echo e($is_vanglai== 1 && isset($vangLaiArr['district_id']) ? $vangLaiArr['district_id'] : $customer->district_id); ?>';
      var customer_ward_id = '<?php echo e($is_vanglai== 1 && isset($vangLaiArr['ward_id']) ? $vangLaiArr['ward_id'] :  $customer->ward_id); ?>';

      $('.edit-address').click(function() {
        $('.address-form').show();
      });
      <?php if(!isset($is_vanglai)): ?>
        <?php if(Session::has('new-register') || Session::has('register') ||
           !$customer->full_name ||
           !$customer->email ||
           !$customer->address ||
           !$customer->phone ||
