        ...
        <div class="page-content">
          ...
          <div class="shipping-address-page">
                ...
                <div class="row row-style-2">
                  <div class="col-lg-12">
                    <?php if(Session::has('update-information')): ?>
                        ...
                        <form class="form-horizontal bv-form" role="form" id="address-info" novalidate>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-8 input-wrap has-feedback">
                                <input type="text" name="full_name" class="form-control address" id="full_name" value="<?php echo e($customer->full_name); ?>" placeholder="Nhập họ tên" data-bv-field="full_name">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-8 input-wrap has-feedback">
                              <input type="tel" name="telephone" class="form-control address" id="telephone" value="<?php echo e($customer->phone); ?>" placeholder="Nhập số điện thoại" data-bv-field="telephone">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-8 input-wrap has-feedback">
                              <textarea name="street" class="form-control address" id="street" placeholder="Ví dụ: 52, đường Trần Hưng Đạo" data-bv-field="street" style="height:50px"><?php echo e($customer->address); ?></textarea>
                          ...
                          <div class="form-group row form-group-radio group-radio-k-address">
                            ...
                            <div class="col-lg-8 input-wrap has-feedback">
                                <label class="checkbox-inline">
                                  ...
                                  <?php if($customer->address_type == 0): ?>
                                  checked
                                  <?php endif; ?>
                                  >
                                   Nhà riêng / Chung cư
                                ...
                                <label class="checkbox-inline">
                                  ...
                                  <?php if($customer->address_type == 1): ?>
                                  checked
                                  <?php endif; ?>
                                  >
                                   Cơ quan / Công ty
...
<?php $__env->startSection('javascript'); ?>
   <script type="text/javascript">
    $(document).ready(function() {
      ...
      var customer_district_id = '<?php echo e($customer->district_id); ?>';
      var customer_ward_id = '<?php echo e($customer->ward_id); ?>';
        ...
        if(error.length) {
          ...
          $.ajax({
            ...
            success : function(data){
              <?php if(Session::get('products') && !empty(Session::get('products'))): ?>
                location.href = "<?php echo e(route('shipping-step-3')); ?>";
              <?php else: ?> 
                location.href = "/";
              <?php endif; ?>
            }
