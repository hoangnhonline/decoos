          ...
          <form class="form-inline" role="form" method="GET" action="<?php echo e(route('contact.index')); ?>" id="frmContact">  
            <div class="form-group">
              <select class="form-control input-sm" id="type" name="type">                                
                  <option value="0" <?php echo e($type == 0 ? "selected" : ""); ?>>Tất cả</option>
                  <option value="1" <?php echo e($type == 1 ? "selected" : ""); ?>>Tư vấn mua hàng</option>
                  <option value="2" <?php echo e($type == 2 ? "selected" : ""); ?>>Phản ánh dịch vụ</option>
                  <option value="3" <?php echo e($type == 3 ? "selected" : ""); ?>>Hợp tác</option>
                  <option value="4" <?php echo e($type == 4 ? "selected" : ""); ?>>Góp ý</option>
              </select> 
            </div>                                           
            <div class="form-group">
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td>
                  ...
                  <?php else: ?>
                    Góp ý
                  <?php endif; ?>]-<?php echo e($item->title); ?></strong></br>
